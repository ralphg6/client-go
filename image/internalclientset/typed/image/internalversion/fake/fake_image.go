...
func (c *FakeImages) Create(image *image.Image) (result *image.Image, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(imagesResource, image), &image.Image{})
	if obj == nil {
		return nil, err
	}
	return obj.(*image.Image), err
...
func (c *FakeImages) Update(image *image.Image) (result *image.Image, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(imagesResource, image), &image.Image{})
	if obj == nil {
		return nil, err
	}
	return obj.(*image.Image), err
