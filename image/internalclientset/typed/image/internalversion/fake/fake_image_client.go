...
import (
	internalversion "github.com/openshift/client-go/image/internalclientset/typed/image/internalversion"
...
func (c *FakeImage) Images() internalversion.ImageInterface {
	return &FakeImages{c}
}
