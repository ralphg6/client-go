...
func (c *FakeBuilds) Create(build *build.Build) (result *build.Build, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(buildsResource, c.ns, build), &build.Build{})
...
func (c *FakeBuilds) Update(build *build.Build) (result *build.Build, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(buildsResource, c.ns, build), &build.Build{})
...
func (c *FakeBuilds) UpdateStatus(build *build.Build) (*build.Build, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(buildsResource, "status", c.ns, build), &build.Build{})
