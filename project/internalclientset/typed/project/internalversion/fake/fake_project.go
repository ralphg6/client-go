...
func (c *FakeProjects) Create(project *project.Project) (result *project.Project, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(projectsResource, project), &project.Project{})
	if obj == nil {
		return nil, err
	}
	return obj.(*project.Project), err
...
func (c *FakeProjects) Update(project *project.Project) (result *project.Project, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(projectsResource, project), &project.Project{})
	if obj == nil {
		return nil, err
	}
	return obj.(*project.Project), err
...
func (c *FakeProjects) UpdateStatus(project *project.Project) (*project.Project, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(projectsResource, "status", project), &project.Project{})
	if obj == nil {
		return nil, err
	}
	return obj.(*project.Project), err
